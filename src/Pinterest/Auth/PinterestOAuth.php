...
namespace WaleedAhmad\Pinterest\Auth;

use WaleedAhmad\Pinterest\Transport\Request;
use WaleedAhmad\Pinterest\Exceptions\PinterestException;
...
class PinterestOAuth {
    ...
    const AUTH_HOST = "https://pinterest.com/oauth/";
     ...
     *
     * @param  string   $code
     * @return \WaleedAhmad\Pinterest\Transport\Response
     */
